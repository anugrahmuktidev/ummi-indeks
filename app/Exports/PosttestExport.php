...
class PosttestExport implements FromCollection, WithHeadings
{
    ...
    {
        // Mengambil data riwayat skrining dengan jenis sesi 'Post Test' dan status 'completed'
        $riwayatPosttest = RiwayatSkrining::with(['user', 'skrining'])
        ...
        return $riwayatPosttest->map(function ($riwayat) {
            ...
            return [
                ...
                'jumlah_edukasi' => $riwayat->jumlah_edukasi, // Pastikan jumlah_edukasi ada dalam tabel
            ];
        });
    }
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            'P10',
            'Total Soal Benar',
            'Jumlah Edukasi', // Menambahkan header untuk jumlah edukasi
        ];
    }
}
