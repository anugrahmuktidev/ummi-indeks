                                    ...
                                    @auth
                                        @if (Auth::user()->isAdmin())
                                            <a href="{{ route('admin.dashboard') }}" class="btn btn-warning btn-lg w-100 fs-4 mb-4">
                                                <i class="ri-dashboard-line me-2"></i>Dashboard Admin</a>
                                        @else
                                            <a href="{{ url('/home') }}" class="btn btn-warning btn-lg w-100 fs-4 mb-4">
                                                <i class="ri-home-4-line me-2"></i>Home</a>
                                        @endif
                                    @else
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                {{-- <p class="mt-3 fs-15 fw-medium text-white"> Prodi Magister Kesehan Universitas
                                    Jambi </p> --}}
